...
<main>
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center .bg-info-subtle">
    <div class="col-md-6 p-lg-5 mx-auto my-5">
      <h1 class="display-2 fw-bold ">Banco de Patrimonios</h1>
      <h3 class="fw-normal text-muted mb-3">Registre seu patrimonio e fique atualizado</h3>
      <div class="d-flex gap-3 justify-content-center lead fw-normal">
        <a class="icon-link" href="cadastro_user.php">
          Cadastro
          <svg class="bi"><use xlink:href="#chevron-right"/></svg>
        </a>
        <a class="icon-link" href="login.php">
          Login
          <svg class="bi"><use xlink:href="#chevron-right"/></svg>
        </a>
      </div>
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 py-3">
        <h2 class="display-5">Sobre o site</h2>
        <p class="lead">Informaçoes sobre o site</p>
      </div>
    ...
    <div class="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 p-3">
        ...
        <p class="lead">Serviços realizados nessa pagina.</p>
      </div>
